...
class Config(QConfig):
    ...
    # desktop lyric
    fireType       = OptionsConfigItem(
        "aimInThisPCGroup", "fireType", "SightGlass", OptionsValidator(["SightGlass", "Normal"]))
    detectConfidence = RangeConfigItem(
        "aimInThisPCGroup", "Confidence", 50, RangeValidator(10, 100))
    nmsSize = RangeConfigItem(
        "aimInThisPCGroup", "Smooth", 30, RangeValidator(10, 100))
